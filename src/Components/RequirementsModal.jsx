...
const { TabPane } = Tabs;
const WrappedForm = Form.create({ name: 'dynamic_form_item' })(RequirementsForm);
            ...
            <Modal
                ...
                <Tabs activeKey={activeTab.toString()}>
                    <TabPane tab="Requirements" key="1">
                        <WrappedForm dataSource = {this.state.setData} columns = {this.state.setColumn}/>
                    </TabPane>
                    <TabPane tab="Relative Intensity" key="2">
                        <NewMatrix dataSource = {this.state.dataSource} columns = {this.state.columns} / >
                    </TabPane>
                </Tabs>
            </Modal>
        );
